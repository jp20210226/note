...
namespace 文件校验
{
    class Program
    {
        ...
        {
            //byte[] a;
            //using (FileStream fs = new FileStream(@"C:\Users\jp\Desktop\e74a4cca-5f30-4ffc-91dc-d8384bdea1aa.ntrd.chena", FileMode.OpenOrCreate, FileAccess.ReadWrite))
            //{
            //    a = new byte[fs.Length];
            //    fs.Read(a,0,a.Length);
            //}
            //uint awa = CRC32_1.GetCRC32(a); 
            
             Console.WriteLine(MD5ces.CreatMD5());
        }
    ...
    public class CRC32
    {
        ...
        public static ulong CalculateBlockCRC32(ulong ulCount, byte[] ucbuffer)
        {
            int ucbuffertag = 0;
            ulong ulTemp1;
            ulong ulTemp2;
            ...
            while (ulCount-- != 0)
            {
                ...
                ulTemp2 = CRC32Value(((int)ulCRC ^ ucbuffer[ucbuffertag++]) & 0xff);
